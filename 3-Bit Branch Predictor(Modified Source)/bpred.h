 ...
 *		    PAp          : N, W, M (M == 2^(N+W))
 *
 *	BPred3bit:  a simple direct mapped bimodal predictor
 *
...
enum bpred_class {
  ...
  BPred3bit,			/* 3-bit saturating cntr pred (dir mapped) */           ///////////**************************************************************[It is fixed]
    //BPred3bit            /*3-bit saturating counter*/
